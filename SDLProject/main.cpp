...
constexpr char othani_SPRITE_FILEPATH[] = "/Users/epochsum/Downloads/triangle/assets/othani.jpg";
constexpr char base_SPRITE_FILEPATH[] = "/Users/epochsum/Downloads/triangle/assets/base.jpg";
    ...
    if (image == NULL)
        {
            ...
            LOG("STB Image Error: " << stbi_failure_reason());
            assert(false);
        }
