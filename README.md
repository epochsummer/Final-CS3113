# “Man in Black,” a top-down 2D shooter 

The mission is simple: "Kill all the aliens before they get to you."
...
This was an intentional design choice. In a top-down shooter, shooting up and down felt awkward and unrealistic—so restricted shooting to horizontal only.
...
Implemented a logic-based shader effect that uses an if statement to darken the screen when the player dies.
...
Used delta time, fixed time step, and the Entity/Map/Scene system.
